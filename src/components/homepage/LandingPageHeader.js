    ...
    <SectionHeader key={(index) => index}>
      <div style={{ position: "relative" }}>
        <HeaderContent headerColor={props.headerColor}>
          <div
            style={{ alignItems: "center", display: "flex", gridGap: "1em" }}
          >
            <MenuIcon
              fontSize="large"
          ...
          <MenuContainer
            menuBgColor={props.bgMenuColor}
            id={props.subMenuHeader}
          >
            <br></br>
            <br></br>
            <br></br>
            ...
            <Link to="/" className="menuItem">
              <MenuItemContent hoverColor={props.contentColor}>
                WHAT IS IT?
              </MenuItemContent>
            </Link>
      ...
      {props.showBtn === false ? null : (
        <Link to="/pricing" className="pricing-link">
          <button
            ...
            style={{ color: `${props.btnTextColor}` }}
          >
            <b>Try it now</b>
          </button>
        </Link>
